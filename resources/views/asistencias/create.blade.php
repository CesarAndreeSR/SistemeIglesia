...
<div class="space-y-8 animate-fade-in">
    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl shadow-lg p-8">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-green-100 mt-1">Marca los usuarios que asistieron a la actividad</p>
                </div>
            </div>
        ...
        <form action="{{ route('asistencias.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-3 max-h-96 overflow-y-auto border-2 border-gray-200 rounded-xl p-4 bg-gray-50">
                        @foreach($users as $user)
                            <div class="flex items-center p-3 bg-white rounded-lg hover:bg-green-50 transition-colors cursor-pointer">
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="px-8 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-200 flex items-center space-x-2 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
