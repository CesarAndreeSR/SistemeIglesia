...
@section('title', 'Ajustes - Iglesia San Marteen')
            ...
            <div class="p-6 md:p-8">
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0">
                        <img src="{{ asset('images/logo/icon.ico') }}" alt="Icono SM" class="w-20 h-20 rounded-2xl shadow-md">
                    </div>
                    <div class="flex-1">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-[#E9D8B6] p-6 hover:shadow-xl hover:border-[#C8A26E] transition-all duration-300">
                ...
                <div class="flex gap-3">
                    <a href="{{ route('settings.show') }}" class="flex-1 bg-[#FAF8F5] border border-[#E9D8B6] text-[#A97142] px-4 py-2.5 rounded-xl hover:bg-[#E9D8B6] transition-all duration-200 font-semibold text-center">
                        Ver perfil
                    </a>
                    <a href="{{ route('settings.profile') }}" class="flex-1 bg-gradient-to-r from-[#C8A26E] to-[#A97142] text-white px-4 py-2.5 rounded-xl hover:shadow-lg transition-all duration-200 font-semibold text-center">
                        Editar perfil
                    </a>
                </div>
            </div>
            ...
            <!-- Cambiar Contraseña -->
            <a href="{{ route('settings.password') }}" class="block bg-white rounded-2xl shadow-lg border border-[#E9D8B6] p-6 hover:shadow-xl hover:border-[#C8A26E] transition-all duration-300">
                <div class="flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-[#C8A26E] to-[#A97142] flex items-center justify-center">
                        <span class="text-2xl">🔐</span>
                    </div>
