...
<div class="space-y-6 animate-fade-in">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
            <!-- Mi Perfil -->
            <a href="{{ route('settings.profile') }}" class="block bg-white rounded-2xl shadow-lg border border-[#E9D8B6] p-6 hover:shadow-xl hover:border-[#C8A26E] transition-all duration-300">
                <div class="flex items-center gap-4">
