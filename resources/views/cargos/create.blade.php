...
<div class="space-y-4 md:space-y-6 animate-fade-in">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <form action="{{ route('cargos.store') }}" method="POST" class="p-5 md:p-8">
            @csrf
            ...
            <div class="space-y-5 md:space-y-6">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="w-full px-4 py-3.5 rounded-xl border-2 border-gray-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all resize-none text-base">{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
