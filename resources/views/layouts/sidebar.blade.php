        ...
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('dashboard.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-blue-700 transition-all duration-200 active:bg-blue-600
                        {{ request()->routeIs('dashboard.*') ? 'bg-blue-700 shadow-lg' : '' }}">
            ...
            <li>
                <a href="{{ route('users.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-blue-700 transition-all duration-200 active:bg-blue-600
                        {{ request()->routeIs('users.*') ? 'bg-blue-700 shadow-lg' : '' }}">
                    <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('cargos.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-blue-700 transition-all duration-200 active:bg-blue-600
                        {{ request()->routeIs('cargos.*') ? 'bg-blue-700 shadow-lg' : '' }}">
                    <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li x-data="{ open: {{ request()->routeIs('actividades.*') ? 'true' : 'false' }} }">
                <button @click="open = !open"
                    class="flex items-center justify-between w-full p-3 rounded-lg hover:bg-blue-700 transition-all duration-200 active:bg-blue-600
                        {{ request()->routeIs('actividades.*') ? 'bg-blue-700 shadow-lg' : '' }}">
                ...
                <div x-show="open"
                    ...
                    <a href="{{ route('actividades.index') }}"
                        class="block py-2 px-2 text-sm rounded-lg text-white/80 hover:text-white hover:bg-blue-700 transition-all
                            {{ request()->routeIs('actividades.index') ? 'text-white font-medium' : '' }}">
                        Todas las actividades
                    </a>
                    <a href="{{ route('actividades.mis') }}"
                        class="block py-2 px-2 text-sm rounded-lg text-white/80 hover:text-white hover:bg-blue-700 transition-all
                            {{ request()->routeIs('actividades.mis') ? 'text-white font-medium' : '' }}">
                        Mis actividades
                    </a>
                </div>
            </li>
            ...
            <li>
                <a href="{{ route('evidencias.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-blue-700 transition-all duration-200 active:bg-blue-600
                        {{ request()->routeIs('evidencias.*') ? 'bg-blue-700 shadow-lg' : '' }}">
                    <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('asistencias.index') }}"
                    class="flex items-center p-3 rounded-lg hover:bg-blue-700 transition-all duration-200 active:bg-blue-600
                        {{ request()->routeIs('asistencias.*') ? 'bg-blue-700 shadow-lg' : '' }}">
                    <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
