        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
            <div class="flex items-start justify-between gap-3">
                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        <p class="font-semibold text-gray-900 text-sm"><?php echo e($cargo->nombre); ?></p>
                        <?php if($cargo->descripcion): ?>
                            <p class="text-xs text-gray-400 mt-0.5 line-clamp-2"><?php echo e($cargo->descripcion); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-medium text-gray-900"><?php echo e($cargo->nombre); ?></span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <span class="text-sm text-gray-500"><?php echo e($cargo->descripcion ?? '-'); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium relative">
                        <div class="relative inline-block text-left">
                            <button onclick="toggleDropdown('dropdown-cargo-<?php echo e($cargo->id); ?>')"
                            ...
                            <div id="dropdown-cargo-<?php echo e($cargo->id); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sistemaIglesia\sistemaIglesia\resources\views/cargos/index.blade.php ENDPATH**/ ?>