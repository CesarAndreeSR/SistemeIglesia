            ...
            <form method="POST" action="<?php echo e(route('register.post')); ?>">
                ...
                <div class="mt-4 text-center">
                    <p class="text-sm text-gray-600">¿Ya tienes cuenta?
                        <a href="<?php echo e(route('login')); ?>" class="text-[#C8A26E] hover:text-[#A97142] font-semibold transition">
                            Inicia sesión
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\xampp\htdocs\sistemaIglesia\sistemaIglesia\resources\views/auth/register.blade.php ENDPATH**/ ?>