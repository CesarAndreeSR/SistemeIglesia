            ...
            <div class="flex items-start justify-between gap-3">
                ...
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <div class="min-w-0">
                        ...
                        <p class="text-xs text-[#C8A26E] truncate"><?php echo e($user->username ?? '-'); ?></p>
                        <?php if($user->email): ?>
                ...
                <span class="shrink-0 px-2.5 py-1 text-xs font-medium rounded-full
                    <?php echo e($user->estado ? 'bg-[#E9D8B6] text-[#A97142]' : 'bg-red-100 text-red-800'); ?>">
        ...
        <table class="min-w-full divide-y divide-[#E9D8B6]">
            ...
            <tbody class="bg-white divide-y divide-[#E9D8B6]">
                ...
                <tr class="hover:bg-[#FAF8F5] transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-sm font-medium text-[#C8A26E]"><?php echo e($user->username ?? '-'); ?></span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
