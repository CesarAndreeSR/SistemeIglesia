    ...
    <div class="bg-white rounded-2xl shadow-lg border border-[#E9D8B6] p-6 md:p-8">
        ...
        <div class="flex flex-col md:flex-row items-center gap-6 mb-8 pb-8 border-b border-[#E9D8B6]">
            ...
            <div class="text-center md:text-left">
                <h2 class="text-2xl font-bold text-[#1F2937]"><?php echo e($user->name); ?></h2>
                <p class="text-[#A97142] font-medium"><?php echo e($user->cargo->nombre ?? 'Sin cargo'); ?></p>
                <p class="text-gray-500 text-sm mt-1">@ <?php echo e($user->username); ?></p>
            </div>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-start gap-4 p-4 bg-[#FAF8F5] rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-[#1F2937]"><?php echo e($user->name); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 bg-[#FAF8F5] rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-[#1F2937]"><?php echo e($user->username); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 bg-[#FAF8F5] rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-[#1F2937]"><?php echo e($user->email ?? 'No registrado'); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 bg-[#FAF8F5] rounded-xl">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-[#1F2937]"><?php echo e($user->telefono ?? 'No registrado'); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-start gap-4 p-4 bg-[#FAF8F5] rounded-xl">
                ...
                <div>
                    ...
                    <span class="px-3 py-1 text-sm font-medium rounded-full <?php echo e($user->estado ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'); ?>">
        ...
        <div class="mt-8 pt-6 border-t border-[#E9D8B6] flex flex-col sm:flex-row gap-4">
            <a href="<?php echo e(route('settings.profile')); ?>" class="flex-1 bg-gradient-to-r from-[#C8A26E] to-[#A97142] text-white px-6 py-3.5 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300 font-semibold text-center">
                Editar perfil
            </a>
            <a href="<?php echo e(route('settings.password')); ?>" class="flex-1 border-2 border-[#C8A26E] text-[#A97142] px-6 py-3.5 rounded-xl hover:bg-[#FAF8F5] transition-all duration-300 font-semibold text-center">
                Cambiar contraseña
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sistemaIglesia\sistemaIglesia\resources\views/settings/show.blade.php ENDPATH**/ ?>