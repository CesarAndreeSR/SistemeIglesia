<header class="bg-white shadow-lg border-b border-[#E9D8B6] relative z-30">
    <div class="flex items-center justify-between px-4 md:px-6 py-4">
        ...
        <div class="md:hidden flex-1 text-center flex items-center justify-center gap-2">
            <img src="<?php echo e(asset('images/logo/icon.ico')); ?>" alt="Icono San Marteen" class="w-8 h-8">
...
<?php /**PATH C:\xampp\htdocs\sistemaIglesia\sistemaIglesia\resources\views/layouts/header.blade.php ENDPATH**/ ?>