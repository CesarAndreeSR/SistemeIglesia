        ...
        <ul class="space-y-2">
            ...
            <li class="border-t border-[#E9D8B6]/30 pt-2">
                <a href="<?php echo e(route('settings.index')); ?>"
                    class="flex items-center p-3 rounded-xl transition-all duration-300 <?php echo e(request()->routeIs('settings.*') ? 'bg-[#E9D8B6] text-[#1F2937] shadow-md' : 'hover:bg-[#A97142] active:bg-[#A97142]'); ?>">
                    <svg class="w-5 h-5 mr-3 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
